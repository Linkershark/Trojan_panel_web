...
```bash
wget -N --no-check-certificate "https://raw.githubusercontent.com/Linkershark/Trojan_panel_web/master/trojan-web-panel.sh" && chmod +x trojan-web-panel.sh && ./trojan-web-panel.sh
```
